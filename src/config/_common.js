...
export const k_square_cw = ['[■²]', ...k_square];
...
export const b_reciprocal_cw = ['(■⁻¹)', ...b_reciprocal];
...
const _power = ['x^■', '^'];
export const k_power = getLabelKey(_power);
const _power_cw = ['■^□', ..._power];
